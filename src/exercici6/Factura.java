 ...
 * 
 *  6.Es desitja desenvolupar un programari de gestió per a la factura de comandes.
Les   dades   que   interessen   en   aquest   model   de   negoci   són:   codi,   client,   data   i
import.   El   programa   ha   de   ser   capaç   de   treballar   amb   qualsevol   nombre   de
factures   (utilitzarem   estructures   dinàmiques   de   dades),   permeten   afegir
factures, esborrar-les per codi, i llistar-les ordenades per import de menys a més
i per data, de menys a més.
 * 
 */
